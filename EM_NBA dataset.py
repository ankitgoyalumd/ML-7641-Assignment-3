# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 18:51:17 2019
...
#Fitting the model and testing different parameters for plotting purpose
...
print(matchfn(y,arr))
labels=['diag','spherical','tied','full']
accu=[0.63,0.66,0.68,0.62]
accu1=[0.63,0.61,0.54,0.64]

index = np.arange(len(labels))
plt.bar(index, accu1)
plt.xlabel('covariance', fontsize=20)
plt.ylabel('accuracy', fontsize=20)
plt.xticks(index, labels, fontsize=20, rotation=30)
plt.title('accuracy of scaled')
plt.show()
