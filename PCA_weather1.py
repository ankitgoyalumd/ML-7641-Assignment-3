# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 02:57:58 2019
...
pca_inv_data=pca.inverse_transform(np.eye(17))
...
pca10=PCA(n_components=17)
pca10.fit(X)
X_1=pca10.transform(X)
#Get the reduced form of the data
#drop_col=[26,17,2,28,23,13,24,25,20,21,22,16]
...
fig = plt.figure()
ax = Axes3D(fig)
ax.scatter(X_1[ans==0][6],X_1[ans==0][8],X_1[ans==0][9],label='Class1',c='red')    
ax.scatter(X_1[ans==1][6],X_1[ans==1][8],X_1[ans==1][9],label='Class2',c='blue') 
...
plt.scatter(X_1[ans==0][6],X_1[ans==0][9],label='Class1',c='red')    
plt.scatter(X_1[ans==1][6],X_1[ans==1][9],label='Class2',c='blue') 
#print(X.head())
plt.show()
